    ...
    <div className="min-h-screen bg-[#0E0E0E] text-white flex overflow-x-hidden font-sans">
      ...
      <aside className="w-[60px] flex-col items-center py-4 border-r border-[#222] bg-[#0E0E0E] hidden md:flex z-50 fixed h-full left-0 top-0">
        ...
        <div className="flex flex-col gap-6 text-white w-full items-center">
            ...
            <Link href="/projects" className="p-2 hover:bg-white/5 rounded-xl transition-colors"><ImageIcon size={22} strokeWidth={1.5} className="text-white/60" /></Link>
            <Link href="/canvas" className="p-2 hover:bg-white/5 rounded-xl transition-colors"><MonitorPlay size={22} strokeWidth={1.5} className="text-white/60" /></Link>
            <Link href="/canvas" className="p-2 hover:bg-white/5 rounded-xl transition-colors"><Crop size={22} strokeWidth={1.5} className="text-white/60" /></Link>
            <Link href="/canvas" className="p-2 hover:bg-white/5 rounded-xl transition-colors"><Aperture size={22} strokeWidth={1.5} className="text-white/60" /></Link>
        </div>
      </aside>
      ...
      <main className="flex-1 w-full flex flex-col md:pl-[60px] min-h-screen bg-[#0E0E0E]">
        ...
        <div className="flex-1 w-full mx-auto px-6 md:px-12 pb-24 flex flex-col gap-12 max-w-[1400px]">
            ...
            {/* Try Video Models Placeholder to speed this up */}
            <div className="flex flex-col gap-6 mt-8">
                <div className="flex items-center justify-between">
                    <h2 className="text-[22px] font-medium flex items-center gap-3">Try video models <span className="p-1.5 rounded-full bg-white/5 text-white/50 hover:bg-white/10 cursor-pointer"><Search size={16}/></span></h2>
                </div>
                <div className="h-[300px] w-full bg-[#111] rounded-2xl flex items-center justify-center border border-white/5 text-white/40">
                   Video models integration here...
                </div>
            </div>
