...
import { CropIcon, X, Play, ChevronDown, ChevronRight } from 'lucide-react';
...
// Remove unused hasImageConnection variable
  ...
  return (
    <div className={`w-72 bg-[#0f0f0f] text-white border rounded-xl shadow-[0_0_30px_rgba(0,0,0,1)] p-0 font-sans transition-all duration-300 ${data.isGenerating ? "border-purple-500 ring-2 ring-purple-500/50 shadow-[0_0_30px_rgba(168,85,247,0.4)] animate-pulse" : "border-white/10 hover:border-white/20"}`}>
